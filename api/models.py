...
class Course(models.Model):
    ...
    class Meta:
        verbose_name_plural = "06.专题课程 OR 学位课模块"
...
class CourseDetail(models.Model):
    ...
    class Meta:
        verbose_name_plural = "07.课程或学位模块课程详情页内容"
...
class Account(models.Model):
    ...
    uid = models.CharField(max_length=64, unique=True, help_text='微信用户绑定和CC视频统计',default=0)  # 与第3方交互用户信息时，用这个uid,以避免泄露敏感用户信息
